...
c  modifed to get to compile with gfortran.  This is taken from DOCK
c  3.7. (20220401) (Trent Balius)
c------------------------------------------------------------------------
...
c--------------------------------------------------------------------------
       ...
       integer memalloc
       real(4) tarray(2), etime, stime, ftime
...
c  dielectric grid is offset +dedge(2,*) so it starts at 0,0,0
     ...
     &                  lksolv(i-ii,j-jj,k-kk)
                   write(6,*) "I AM HERE 441 ... ",ii,jj,kk
                   call flush (6)
                 enddo
               enddo
             enddo
