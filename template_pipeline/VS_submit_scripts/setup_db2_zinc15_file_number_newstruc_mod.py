...
# modify to work to setup DOCK6 (2022/09/12) 
...
if not (fastflag): 
   ...
   filedata.sort(key=lambda b: b.size,reverse=True)
#handel.closed
...
os.system("ln -s ../dock6files/ "+tdirname) # make a symbolic link to the dockfiles here. 
