...
pruning_orient_score_cutoff                                  ${energy_val}
pruning_max_conformers                                       ${clustercutoff}
...
foreach anchor ($list)
  ...
  if ( -z output_anchor${count}_scored.mol2 || !(-e output_anchor${count}_scored.mol2) ) then
     ...
     #python ${dockhome}/template_pipeline/hdb_lig_gen/mol2db2/mol2db2.py --norotateh -m output_anchor${count}_scored.mol2 -s output.solv -n name.txt -o output_anchor${count}_scored.db2.gz -v
     ...
     #python ${dockhome}/template_pipeline/hdb_lig_gen/mol2db2/mol2db2.py --norotateh -m output_anchor${count}_scored_mod.mol2 -s output.solv -n name.txt -o output_anchor${count}_scored.db2.gz -v
     python ${dockhome}/template_pipeline/hdb_lig_gen/mol2db2/mol2db2.py --noreseth --norotateh -m output_anchor${count}_scored_mod.mol2 -s output.solv -n name.txt -o output_anchor${count}_scored.db2.gz -v
     cat lig.mol2 output_anchor${count}_scored_mod.mol2 > output_anchor${count}_scored_mod_seed.mol2 
     python ${dockhome}/template_pipeline/hdb_lig_gen/mol2db2/mol2db2.py --noreseth --norotateh -m output_anchor${count}_scored_mod_seed.mol2 -s output.solv -n name.txt -o output_anchor${count}_scored_seed.db2.gz -v
  endif
  @ count = $count + 1
end
